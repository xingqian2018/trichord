...
Lives at `pipelines/image/text_rendering/lancedb_slice.py` in `imaginaire4_sila`.
...
slaunch cpu 8x1 slice_<dataset_name> \
    pipelines/image/text_rendering/lancedb_slice.py \
...
Example (single dataset, confirmed working 20260820):

```bash
CONTAINER_WORKDIR=/home/xingqianx/Project/imaginaire4_sila \
slaunch cpu 8x1 slice_synthetic_scene_text_v0 \
    pipelines/image/text_rendering/lancedb_slice.py \
    --input_lancedb_path gs://nv-00-10206-lancedb/prod/image/image_meta_table_full.lance \
    --dataset_name synthetic_scene_text_v0 \
    --output_lancedb_path \
        gs://nv-00-10206-vfm/lancedb/image/synthetic_text/synthetic_scene_text_v0_slice_from_maintable_20260820.lance \
    --lancedb_credential credentials/gcs.secret
```
